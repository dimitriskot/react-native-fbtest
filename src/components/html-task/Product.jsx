...
const Product = props => {
  ...
  return (
    <div className={"product"}>
      ...
      />
      <label
        className={classNames("product-body", product.isDefaultChecked && "product-body--hover")}
        htmlFor={product.id}
      ...
      >
        ...
        <p className={"product-body__subtitle product-body__subtitle--question"}>Котэ не одобряет?</p>
        ...
        {!!product.presents.text && (
          <p className={"product-body__consists"}>{product.presents.text}</p>
        )}
      ...
      >
        {!product.isChecked && !product.isDisabled && (
          <p>
            ...
            <label
              className={"product-footer__label"}
              htmlFor={product.id}
